...
$(document).ready(function(){
    $(".im1").hover(function(){
        $(this).css("box-shadow","0px 0px 8px 5px");
    },
	function(){
...
<a class="down" href='dounloadfile.php?nama=<?php echo $row['file_path']?>'><li><strong><i class="fa fa-file-pdf-o"></i></strong><?php echo $row['file_name']?><hr  class="hr2"/></a></li>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
								...
								<img class="im1" src="image/add/2.jpeg"  width="320px" height="165px">
							
								<img class="im1" src="image/add/3.jpeg"  width="320px" height="165px">
								<img class="im1" src="image/add/4.jpeg"  width="320px" height="165px">
								<img class="im1" src="image/add/5.jpeg"  width="320px" height="165px">
